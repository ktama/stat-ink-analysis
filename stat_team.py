...
def filter(df):
    ...
    if len([s for s in header if 'W1' in s]) > 0:
        ...
        return df.drop(['# period', 'game-ver', 'lobby-mode', 'lobby', 'mode', 'stage', 'time', 'win',
                        'A1-weapon', 'A1-kill-assist', 'A1-kill', 'A1-assist', 'A1-death', 'A1-special', 'A1-inked', 'A1-rank', 'A1-level',
                        'A2-weapon', 'A2-kill-assist', 'A2-kill', 'A2-assist', 'A2-death', 'A2-special', 'A2-inked', 'A2-rank', 'A2-level',
                        'A3-weapon', 'A3-kill-assist', 'A3-kill', 'A3-assist', 'A3-death', 'A3-special', 'A3-inked', 'A3-rank', 'A3-level',
                        'A4-weapon', 'A4-kill-assist', 'A4-kill', 'A4-assist', 'A4-death', 'A4-special', 'A4-inked', 'A4-rank', 'A4-level',
                        'B1-weapon', 'B1-kill-assist', 'B1-kill', 'B1-assist', 'B1-death', 'B1-special', 'B1-inked', 'B1-rank', 'B1-level',
                        'B2-weapon', 'B2-kill-assist', 'B2-kill', 'B2-assist', 'B2-death', 'B2-special', 'B2-inked', 'B2-rank', 'B2-level',
                        'B3-weapon', 'B3-kill-assist', 'B3-kill', 'B3-assist', 'B3-death', 'B3-special', 'B3-inked', 'B3-rank', 'B3-level',
                        'B4-weapon', 'B4-kill-assist', 'B4-kill', 'B4-assist', 'B4-death', 'B4-special', 'B4-inked', 'B4-rank', 'B4-level'], axis=1)
